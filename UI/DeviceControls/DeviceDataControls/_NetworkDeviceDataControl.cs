...
namespace DiscoveryLight.UI.DeviceControls.DeviceDataControls
{
    public partial class _NetworkDeviceDataControl : DeviceDataControl
    {
        ...
        protected override void show()
        {
            ...
            lbl_Tipology_Value.Text = DataConvert.AsDefaultValue(CurrentSubDevice.NetConnectionID, "N/A");
            ...
            lbl_MACAddress_Value.Text = DataConvert.AsDefaultValue(CurrentSubDevice.MACAddress, "N/A");
            lbl_IPAddress_Value.Text = DataConvert.AsDefaultValue(CurrentSubDevice.IpAddress, "N/A");
            ...
            lbl_SubnetMask_Value.Text = DataConvert.AsDefaultValue(CurrentSubDevice.IpSubnet, "N/A");
            lbl_Getway_Value.Text = DataConvert.AsDefaultValue(CurrentSubDevice.DefaultIPGateway, "N/A");
        }
    }
}
